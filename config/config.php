...
|
*/
$config['botToken'] = "1443377934:AAEjZ_CZnzUwpPmfqWyqFYjznoBqfco2Vpc";
...
$config['db']['username'] =  "sql3448067";
$config['db']['password'] =  "UlqlkH7zdL";
$config['db']['database'] =  "sql3448067";
